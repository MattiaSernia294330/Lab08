...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._txtYears = ft.TextField(label="Insert max years", on_change=self._controller.read_maxY)
        self._txtHours = ft.TextField(label="Insert max hours", on_change=self._controller.read_maxH)
